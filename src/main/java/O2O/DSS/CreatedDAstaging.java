 ...
 *
 */
public class CreatedDAstaging {
	void Staging() throws InterruptedException, IOException {
		System.setProperty("webdriver.chrome.driver",
				"C:\\Users\\USER\\eclipse-workspace\\chrome 83\\chromedriver.exe");
		WebDriver driver = new ChromeDriver();
		driver.get("https://agentstaging.dxres.vn/login");
		...
		for (int i = 1; i <= i++; i++) {
			...
			driver.findElement(By.xpath("//*[@id=\"main-content\"]/app-project-list/div/div[1]/div[1]/div/button"))
					.click(); // Create
			Thread.sleep(1000);
			...
			driver.findElement(By.xpath(
					...
					.sendKeys("Trần Nguyên Huy"); // TruongDA
			Thread.sleep(2000);
			driver.findElement(By.xpath("//*[@fxlayoutalign='center start'][text()='Trần Nguyên Huy']")).click();
			...
			driver.findElement(By.xpath(
					...
					.click();
			driver.findElement(
					By.xpath("//*[@class='ng-option-label ng-star-inserted'][text()='Thanh toán qua tín dụng']"))
					.click();
			Thread.sleep(1000);
			driver.findElement(By.xpath(
			...
			Thread.sleep(1000);
			driver.findElement(
					By.xpath("//*[@class='ng-option-label ng-star-inserted'][text()='Thanh toán bằng tiền mặt']"))
					.click();
